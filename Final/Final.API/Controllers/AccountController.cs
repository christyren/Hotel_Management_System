...
namespace Final.API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private string CreateJWT(UserLoginResponseModel model)
        {
            ...
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration["FinalSecretKey"]));
            ...
            var tokenObject = new SecurityTokenDescriptor()
            {
                ...
                Issuer = _configuration["FinalIssuer"],
                Audience = _configuration["FinalAudience"]
            };
